...
public:
    ...
    virtual QueryResult<Artifact::Ptr>::Ptr findArtifacts(const Project::Ptr &project) const = 0;
    virtual QueryResult<Artifact::Ptr>::Ptr findTopLevelArtifacts(const Project::Ptr &project) const = 0;
};
