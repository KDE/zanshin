...
TaskApplicationModel::TaskApplicationModel(QObject *parent)
    : ApplicationModel(parent)
{
}

TaskApplicationModel::~TaskApplicationModel()
{
}

RunningTaskModelInterface *TaskApplicationModel::runningTaskModel()
{
