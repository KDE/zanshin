...
#ifndef QUICKSELECTDIALOG_H
#define QUICKSELECTDIALOG_H
...
class QuickSelectDialog : public QDialog
{
    Q_OBJECT
public:
    explicit QuickSelectDialog(QWidget *parent = Q_NULLPTR);

    QPersistentModelIndex selectedIndex() const;
