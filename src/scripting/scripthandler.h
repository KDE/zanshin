...
#ifndef SCRIPTING_SCRIPTHANDLER_H
...
class ScriptHandler : public QObject
{
    Q_OBJECT
public:
    explicit ScriptHandler(const Domain::TaskRepository::Ptr &taskRepository, QObject *parent = nullptr);
...
#endif // SCRIPTING_SCRIPTHANDLER_H
