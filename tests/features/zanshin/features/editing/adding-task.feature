Feature: Adding tasks
  ...
  Examples:
    | page                                              | title                 |
    | Inbox                                             | Buy a book            |
    | Projects / TestData » Calendar1 » Calendar2 / Backlog | Setup a release party |
  ...
  Examples:
    ...
    | Projects / TestData » Calendar1 » Calendar2 / Backlog | Setup a release party | Make sure there was a release |
