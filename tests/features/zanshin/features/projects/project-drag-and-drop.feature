Feature: Project task association
  ...
  Scenario: Dropping a task on a project
    ...
    When I drop the item on "Projects / TestData » Calendar1 / Read List" in the page list
    And I display the "Projects / TestData » Calendar1 / Read List" page
  ...
  Scenario: Dropping a task on a project from context central list
    ...
    When I drop the item on "Projects / TestData » Calendar1 » Calendar2 / Backlog" in the page list
    And I display the "Projects / TestData » Calendar1 » Calendar2 / Backlog" page
    And I look at the central list
    And I list the items
    Then the list is:
       | display                                       |
